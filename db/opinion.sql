...
--
-- 資料表結構 `survry_options_hw`
--

CREATE TABLE `survry_options_hw` (
  `id` int(12) UNSIGNED NOT NULL,
  `subject_id` int(12) UNSIGNED NOT NULL,
...
INSERT INTO `users_hw` (`id`, `acc`, `pw`, `name`, `creaded_at`, `last_login`) VALUES
...
(4, 'meow_lee', '123', 'luna', '2022-12-25 03:12:30', '2022-12-25 03:12:30'),
...
(13, 'test', '123', 'yes', '2022-12-25 03:12:53', '2022-12-25 03:12:53');
...
--
-- 資料表索引 `survry_options_hw`
--
ALTER TABLE `survry_options_hw`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `survry_options_hw`
--
ALTER TABLE `survry_options_hw`
  MODIFY `id` int(12) UNSIGNED NOT NULL AUTO_INCREMENT;
