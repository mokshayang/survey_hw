        ...
        <form action="api/admin_reg.php" method="POST" autocomplete="off" class="col col-lg-6 col-md-8 my-5 mb-3" onSubmit="return checkForm()">
            <div class="content">
                ...
                <div class="input-group mb-4 col-8">
                    ...
                    <input id="pw" name="pw" type="password" class="form-control" placeholder="請輸入3字以上" required onChange="censorpw()">
            ...
            <div class="text-center col-12 my-4">
                ...
                <input class="btn btn-warning shadow mx-1" type="reset" value="清空">
                <input class="btn btn-primary shadow mx-1" type="submit" value="新增">
            </div>
        </form>
